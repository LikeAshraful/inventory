...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                                ...
                                <div class="text-center w-75 m-auto mb-4">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{asset('backend/assets/images/logo.png')}}" alt="" height="90">
                                            </span>
                                        </a>
        ...
        <footer class="footer footer-alt">
            2015 - <script>document.write(new Date().getFullYear())</script> &copy; All right Reserved <a href="" class="text-white-50">amarpos</a> 
        </footer>
