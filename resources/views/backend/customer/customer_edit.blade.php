			...
			<div class="col-12">
				<div class="card mt-3">
					<div class="card-body">
						...
						<h4 class="card-title">Customer Edit Page </h4><br><br>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="row ">
										...
										<div class="col-sm-10">
											<input name="shopname" class="form-control" type="text"   value="{{ $customer->shopname }}" >
										</div>
									</div>
								</div>
								<!-- end row -->
								...
								<div class="col-md-6">
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<input name="nid" class="form-control" type="text" value="{{ $customer->nid }}">
										</div>
									</div>
								</div>
								<!-- end row -->
								...
								<div class="col-md-6">
									<div class="row ">
										...
										<div class="col-sm-10">
											<input name="previous_due_amount" class="form-control" type="text"  value="{{ $customer->previous_due_amount }}">
										</div>
									</div>
								</div>
								<!-- end row -->
								...
								<div class="col-md-6">
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<textarea class="form-control" name="note" id="example-textarea" rows="5" value="{{ $customer->note }}"></textarea>
										</div>
									</div>
								</div>
								<!-- end row -->
