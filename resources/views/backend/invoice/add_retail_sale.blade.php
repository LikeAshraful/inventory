...
<div class="page-content">
   <div class="container-fluid">
      <div class="row">
         <div class="col-12">
            <div class="card mt-2">
               <form method="POST" action="{{ route('retailsale.store') }}" id="productForm">
                  @csrf
				   
                  <div class="card-body row">
                     <div class="col-md-9">
                        <h4 class="card-title">Retail Sale Entry Page</h4>
                        <br><br>
                        <div class="row">
                           <div class="col-md-2">
                              <div class="md-3">
                           ...
                           <div class="col-md-2" style="margin-top:30px;">
                              <div class="md-3">
                                 ...
                                 <i class="btn btn-secondary btn-rounded waves-effect waves-light addeventmore" id="addMoreButton"> Add More</i>
                              </div>
                           </div>
                        </div>
                        <!-- end row -->
