...
<div class="card">
    <div class="card-body">
	<a class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;" href="{{ route('export') }}">Download Xlsx</a>
	...
	<h4 class="card-title">Import Product</h4><br><br>
