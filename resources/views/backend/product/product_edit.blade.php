							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="row">
										...
										<div class="col-sm-10">
											<input name="buying_price" class="form-control" type="text"  value="{{ $product->buying_price }}"  >
										</div>
									</div>
								</div>
								<!-- end row -->
								...
								<div class="col-md-6">
									<div class="row mb-3">
										...
										<div class="col-sm-10">
											<input name="retail_sale" class="form-control" type="text"  value="{{ $product->retail_sale }}"  >
										</div>
									</div>
								</div>
								<!-- end row -->
								...
								<div class="col-md-6">
									<div class="row">
										...
										<div class="col-sm-10">
											<input name="wholesale" class="form-control" type="text"   value="{{ $product->wholesale }}" >
										</div>
									</div>
								</div>
								<!-- end row -->
